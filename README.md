...
- 一定時間無操作時のマウスジグル
![a1.jpg](./pict/A1.jpg "a1.jpg")
![a2.jpg](./pict/A2.jpg "a2.jpg")
![a3.jpg](./pict/A3.jpg "a3.jpg")
![a4.jpg](./pict/A4.jpg "a4.jpg")

## 日本語キーボード
ardiunoの基本だと英語キーボードになってます。そのままだと使えないので ** USBHIDKeyboard_JIS.h ** を作成し無理やり対応させています。
...
キー割り当てはアプリを作って作成しました。
[https://github.com/bryful/rp2040Zero_Keybord](https://github.com/bryful/rp2040Zero_Keybord)
